...
public class FacesDetectedEvent extends Event<FacesDetectedEvent> {
  ...
  private  String frameDPS_base64;

  private WritableArray mData;

  private FacesDetectedEvent() {}

  public static FacesDetectedEvent obtain(int viewTag, WritableArray data, String frameDPSbase64) {
    FacesDetectedEvent event = EVENTS_POOL.acquire();
    if (event == null) {
      event = new FacesDetectedEvent();

    }
    event.init(viewTag, data,frameDPSbase64);
    return event;
  }

  private void init(int viewTag, WritableArray data,String frameDPSbase64) {

    super.init(viewTag);
    frameDPS_base64 = frameDPSbase64;
    mData = data;
  }
  ...
  private WritableMap serializeEventData() {
    ...
    event.putString("frame", frameDPS_base64);
    return event;
  }
}
